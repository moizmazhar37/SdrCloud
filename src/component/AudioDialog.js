    ...
    reader.onload = () => {
      ...
      audio.onloadedmetadata = () => {
        ...
        if (duration > videoDuration) {
          toast.error(
            `Audio duration ${duration.toFixed(
              2
            )} is greater than video duration.`
          );
        } else {
  ...
  return (
    ...
    >
      <Box className="headingBox">
        <h2>
          Upload {selectedAudioType === "audio" ? "Audio" : "Audio Script"}
        </h2>
      ...
      <DialogActions className="dialogAction">
        <Button className="btnSubmit" onClick={handleSubmit} color="primary">
          Submit
        </Button>
        <Button
          className="btnClose"
