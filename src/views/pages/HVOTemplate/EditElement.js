...
function EditElement({
  ...
  console.log("loading in the eidt Elements: ", linkObject?.headerLogo);
  ...
  console.log(linkObject, "linkObjectlinkObject");
  // const [logos, setLogos] = useState({
  //     Logo1: null,
  //     Logo2: null,
  //   });
  ...
  console.log(selectedDynamicOptionDemo, "selectedDynamicOptionDemo");
  console.log(staticURLDemo, "staticURLDemo");
  ...
  const EditSectionbyId = async () => {
    ...
    console.log(staticImage, "sdfdsfds-----------------fgfdgdf");
                  ...
                  {/* {scrollSelect === true && (
                    <Box mt={"4px"} mb={"8px"} ml={1}>
                      <Typography style={{ color: "red" }}>
                        *Selecting 'Scroll' will disable the option to add a CTA
                        link to the banner
                      </Typography>
                    </Box>
                  )} */}
                  ...
                  <TextField
                    ...
                    onChange={(e) => {
                      ...
                      if (value.length <= 60) {
                        ...
                        setError((prevError) => ({
                          ...prevError,
                          bannerText: "Maximum 60 characters allowed",
                        }));
                      }
                    }}
                    variant="outlined"
                    ...
                    onChange={(e) => {
                      ...
                      if (value === "00" || value === "0") {
                        ...
                        if (Number(value) <= 18) {
                          ...
                          setError((prevError) => ({
                            ...prevError,
                            bannerTextSize: "Value must be 18 or less",
                          }));
                        }
                      }
                    }}
                  ...
                  InputProps={{
                    ...
                    endAdornment: (
                      <InputAdornment position="end">
                        ...
                        <Button
                          className="savebtn"
                          onClick={() => handleIconButtonClick("image")}
                        >
                          Upload
                        </Button>
                      </InputAdornment>
            ...
            <Grid container spacing={3} style={{ display: "flex" }}>
              ...
              {/* <Grid item xs={12}>
                ...
                >
                  ...
                  <div style={{ height: "980px", overflowY: "auto" }}>
                    {companyDetails !== undefined &&
                      companyDetails.length > 0 &&
                      companyDetails
                        ?.filter((item) => item?.dataType == "Text Field")
