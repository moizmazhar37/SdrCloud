...
function HeroSection({
  ...
  //   const res = await postApiHandlerWithToken("uploadImage", formData);
  //   if (!res) {
  //     toast.error("Unable to upload media", { id: id });
  //     return;
  //   }
  ...
  const handleFileInputChange = async (event) => {
    ...
    // await handleStaticUpload(formData);
  ...
  const handleSetData = async () => {
    ...
    // if (demobuttonText === "") newError.demo = "Demo Button text is required.";
        ...
        <Grid container spacing={3}>
              ...
              InputProps={{
                ...
                endAdornment: (
                  <InputAdornment position="end">
                    ...
                    />
                    <Button className="savebtn" onClick={handleIconButtonClick}>
                      Choose
                    </Button>
                  </InputAdornment>
                ),
          ...
          <Grid item xs={12} sm={8}>
            <Grid container style={{ gap: "15px" }}>
                ...
                <>
                  ...
                  >
                    ...
                    >
                      ...
                      />
                      <div className={classes.colorpickerbtndiv}>
                        <Button onClick={handleSaveColorH2} variant="outlined">
                          Save
                        </Button>
                        <Button
              ...
              <Grid item xs={10}>
                ...
                <span className={classes.hinttext}> (Max 200 Characters)</span>
              </Grid>
              <Grid item xs={1} className="sizeField">
                <Typography className="label">Size</Typography>
                <TextField
            ...
            <>
              ...
              >
                ...
                >
                  ...
                  />
                  <div className={classes.colorpickerbtndiv}>
                    <Button onClick={handleSaveColorBtnText} variant="outlined">
                      Save
                    </Button>
                    <Button
              ...
              >
                ...
                >
                  ...
                  <div className={classes.colorpickerbtndiv}>
                    ...
                    <Button onClick={handleCancelColorBtn} variant="contained">
                      Cancel
                    </Button>
                  </div>
                </Box>
          ...
          <Grid item xs={12} sm={6}>
            ...
            >
              ...
              {/* <MenuItem value={companyDetails[0]?.companyUrl}>
                Company Url
              </MenuItem>
              <MenuItem value={companyDetails[0]?.linkedIn}>
                LinkedIn Url
              </MenuItem>
              <MenuItem value={companyDetails[0]?.mapsUrl}>Map Url</MenuItem>
              <MenuItem value={companyDetails[0]?.facebook}>
                Facebook Url
              </MenuItem> */}
            </Select>
            ...
            <>
              ...
              >
                ...
                >
                  ...
                  />
                  <div className={classes.colorpickerbtndiv}>
                    <Button onClick={handleSaveColorDemoBtn} variant="outlined">
                      Save
                    </Button>
                    <Button
