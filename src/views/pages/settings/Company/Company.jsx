...
const Company = () => {
  ...
  // Header configurations for each table
  const tableHeaders = {
    account_details: [
    ...
    account_logo: [
      { key: "uploadLogo", label: "Upload Logo" }
    ],
    view_agreement: [
      { key: "viewAgreement", label: "View Agreement" }
    ]
  };

  // Display names for the section headings
  const displayNames = {
  ...
  // Render all tables by mapping through the data
  return (
